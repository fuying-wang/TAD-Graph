...
import os
import pdb
from tadgraph.wsi_core.util_classes import Mosaic_Canvas
...
def StitchCoords(hdf5_file_path, wsi_object, downscale=16, draw_grid=False, bg_color=(0,0,0), alpha=-1):
    ...
    downsample_scale = 2 ** patch_level 
    patch_size = (patch_size * downsample_scale, patch_size * downsample_scale)
