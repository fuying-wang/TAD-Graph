...
import os
import pandas as pd
from tadgraph.utils.utils import *
from PIL import Image
from math import floor
import matplotlib.pyplot as plt
from tadgraph.datasets.wsi_dataset import Wsi_Region
import h5py
...
def compute_from_patches(wsi_object, clam_pred=None, model=None, feature_extractor=None, batch_size=512,
    ...
    roi_loader = get_simple_loader(
        roi_dataset, batch_size=batch_size, num_workers=8)
